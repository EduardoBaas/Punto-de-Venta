...
namespace PuntoDeVenta
{
	...
	public class proveedor
	{
		...
		{
			string sql= string.Format("INSERT INTO proveedores(nombre_proveedor,direccion,correo,telefono,rfc,duenio) VALUES ('{0}','{1}','{2}','{3}','{4}','{5}');",nombre,direccion,correo,telefono,rfc,duenio);
			FrameBD.SQLIDU(sql);
		}
